...
public class MoviesActivity extends AppCompatActivity implements OnMovieClickListener {
    ...
    private void loadMovies() {
        ...
        movie10.setImageRes(R.drawable.main_avengersinfinitywar);
        ...
        movie10.setBackImageRes(R.drawable.bk_avengersinfinitywar);
        ...
        movie10.setReleaseDate("2018-04-26");
        ...
        movie10.setTrailerUrl("https://www.youtube.com/watch?v=6ZfuNTqbHE8");
        ...
        MoviesContent.addMovie(movie10);
    }
}
